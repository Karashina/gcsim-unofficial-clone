...
var WeaponNameToKey = map[string]keys.Weapon{
	...
	"agdh":                            keys.AshGravenDrinkingHorn,
	...
	"fomk":                            keys.FangOfTheMountainKing,
	"mountainking":                    keys.FangOfTheMountainKing,
	...
	"rainbow":                         keys.FootprintOfTheRainbow,
