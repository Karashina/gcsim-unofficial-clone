...
func init() {
	...
	// bikeplunge
	bikePlungeFrames = frames.InitAbilSlice(47)
}
...
func (c *char) bikePlunge() action.Info {

	ai := combat.AttackInfo{
		ActorIndex:     c.Index,
		Abil:           "Flamestrider Plunge DMG",
		AttackTag:      attacks.AttackTagPlunge,
