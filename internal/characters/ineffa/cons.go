...
const c1Dur = 15 * 60
const c1Key = "ineffa-c1"
const c2Key = "ineffa-c2"
const c2Per = 2.4
const c2Dur = 15 * 60
const c4Extra = 6
const c4ExtraScaling = 1
const c4Limit = 7
const c4Key = "ineffa-c4"
const c4Regen = 2.0
const c6Key = "ineffa-c6"
const c6Limit = 6
const c6Scaling = 5
const c6ICD = 0.5 * 60
const c6ICDKey = "ineffa-c6-icd"
...
func (c *char) c1() {
	...
	for _, char := range c.Core.Player.Chars() {
		// TODO: check if this buff is affected by hitlag on characters or hitlag on ineffa
...
func (c *char) c2Init() {
	...
	c.Core.Events.Subscribe(event.OnEnemyHit, func(args ...interface{}) bool {
		...
		if c.Core.Flags.LogDebug {
			c.Core.Log.NewEvent("ineffa C2 proc dmg add", glog.LogPreDamageMod, atk.Info.ActorIndex).
