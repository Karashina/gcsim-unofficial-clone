...
// ・ゑｽｷ Luminous Illusion DMG is increased by 65%.
// ・ゑｽｷ The Tranquility Aura遯ｶ蜀ｱ duration is extended by 6s.
func (c *char) c1() {
...
// After characters affected by the Golden Chalice遯ｶ蜀ｱ Bounty deal Hydro DMG to opponents, that opponent遯ｶ蜀ｱ Hydro RES will be decreased by 35% for 10s.
// After a triggered Bloom reaction deals DMG to opponents, their Dendro RES will be decreased by 35% for 10s.
// You need to have unlocked the 遯ｶ蟒嗤urt of Dancing Petals遯ｶ繝ｻTalent.
func (c *char) c2() {
...
// After the third dance step of Dance of Haftkarsvar遯ｶ繝ｻ Pirouette hits opponents, Nilou will gain 15 Elemental Energy,
...
// For every 1,000 points of Max HP, Nilou遯ｶ蜀ｱ CRIT Rate and CRIT DMG will increase by 0.6% and 1.2% respectively.
