...
func init() {
	...
	lowPlungeFrames[action.ActionSkill] = lowPlungeHitmark // 以前は42
	lowPlungeFrames[action.ActionBurst] = lowPlungeHitmark // 以前は43
	...
	highPlungeFrames[action.ActionSkill] = highPlungeHitmark // 以前は45
	highPlungeFrames[action.ActionBurst] = highPlungeHitmark // 以前は44
